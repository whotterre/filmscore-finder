...
- Add shadow DOM traversal (recommended if titles aren't being found), or
- Add a Settings view to store a personal OMDb key, or
- Switch to TMDb and fetch posters/ratings there.
